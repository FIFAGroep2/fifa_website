<div id="header">
    <div class="container">
        ...
        <nav>
            ...
            <a href="finales.php"><i class="fas fa-star"></i>Finales</a>
            <?php
            ...
            <?php if((isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == true)
                ...
                <a href=""><i class="fas fa-users"></i>Team aanmaken</a>

            <?php } ?>
            <?php if((isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == true)
                || (isset($_SESSION['isCaptain']) && $_SESSION['isCaptain'] == true)){ ?>

                <a href=""><i class="fas fa-sort-numeric-up"></i>Standen invoeren</a>
